...
<div class="container-fluid mt-4 px-4">
    <form action="{{ route('order.update', $order->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <!-- Bắt buộc phải có để Laravel hiểu đây là route Update -->
                    ...
                    <tbody id="itemTableBody">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="number" step="0.01" name="items[{{ $index }}][don_gia_te]"
                                    value="{{ $item->don_gia_te }}" class="form-control form-control-sm mb-2"
                                    placeholder="Giá (Tệ)">
    ...
    btnAddItem.addEventListener('click', function() {
        ...
        newRow.innerHTML = `
            ...
            <td>
                ...
                <input type="number" step="0.01" name="items[${itemIndex}][don_gia_te]" class="form-control form-control-sm mb-2" placeholder="Giá (Tệ)">
