...
<head>
    ...
    <title>Bảng giá Quảng Châu - HTKK 360</title>
        ...
        <div class="container">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 font-12">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Báo giá vận chuyển hàng Quảng Châu
                    </li>
                </ol>
            </nav>
        </div>
                    ...
                    <div class="p-4">
                        ...
                        <div class="table-responsive mb-3">
                            ...
                            <table class="table custom-hover-table align-middle">
                                ...
                                <tbody>
                                    <tr>
                                        <td class="text-start fw-semibold">1. Phí vận chuyển</td>
                        ...
                        <h5 class="fw-bold mb-2" style="color: #0b3a68;">4. Phí đóng gỗ</h5>
                        <div class="table-responsive mb-5">
                            <table class="table custom-hover-table align-middle">
                                <thead>
                                    <tr>
                        ...
                        <h5 class="fw-bold mb-2" style="color: #0b3a68;">5. Phí bảo hiểm</h5>
                        <div class="table-responsive mb-5">
                            <table class="table custom-hover-table align-middle">
                                <thead>
                                    <tr>
